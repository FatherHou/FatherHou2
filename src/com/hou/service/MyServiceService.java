 ...
 * 
 */
@WebServiceClient(name = "MyServiceService", targetNamespace = "http://service.hou.com/", wsdlLocation = "http://localhost:8000/HouService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYSERVICESERVICE_QNAME = new QName("http://service.hou.com/", "MyServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8000/HouService?wsdl");
    ...
    public MyService getMyServicePort() {
        return super.getPort(new QName("http://service.hou.com/", "MyServicePort"), MyService.class);
    }
    ...
    public MyService getMyServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.hou.com/", "MyServicePort"), MyService.class, features);
    }
